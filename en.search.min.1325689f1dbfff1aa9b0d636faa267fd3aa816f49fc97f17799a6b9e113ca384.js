...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.99996b7366a46c660349a464c64a390d9fc3f1ce8ddb598c45e49a102d9835ca.js',function(){input.required=false;search();});}
